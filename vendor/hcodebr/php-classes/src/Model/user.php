...
class User extends Model{
	...
	public static function login($login, $password){
		...
		if (count($results) === 0) {
			throw new \Exception("Usuário ou senha inexistente");			
		}
	...
	public static function getForgot($email){
		...
		if(count($results) === 0){
			throw new \Exception("Não foi  possível recuper a senha");			
		}
		else{
	...
	public static function validForgotDecrypt($code){
		...
		$idrecorvery = mcrypt_decrypt(MCRYPT_RIJNDAEL_128, User::SECRET, base64_decode($code), MCRYPT_MODE_ECB);
